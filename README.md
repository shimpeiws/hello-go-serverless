...
This is a sample template for hello-go-serverless - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name hello-go-serverless --query 'Stacks[].Outputs'
```
